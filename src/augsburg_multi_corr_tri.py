...
sys.path.append('..')
from models.surf_corr_repr import SURF_CR_TRI
...
def deeppix_main(args):
    ...
    if 1 not  in args.p:
        args.model_root = args.model_root + "/corr_drop"
        args.log_root = args.log_root + "/corr_drop"
    else:
        args.model_root=args.model_root+"/corr_full"
        args.log_root=args.log_root+"/corr_full"
    ...
    model = SURF_CR_TRI(args, modality_1_channel, modality_2_channel, modality_3_channel)
    # 如果有GPU
