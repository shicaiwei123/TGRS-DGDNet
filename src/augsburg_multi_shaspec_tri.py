...
from lib.model_develop import train_base_multi_shaspec_tri
...
def deeppix_main(args):
    ...
    args.retrain = False
    train_base_multi_shaspec_tri(model=model, cost=criterion, optimizer=optimizer, train_loader=train_loader,
