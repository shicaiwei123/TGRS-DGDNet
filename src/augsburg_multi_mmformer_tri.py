...
sys.path.append('..')
from models.surf_mmfomer import HSI_Lidar_Couple_Former_TRI
from src.augsburg_dataloader import augsburg_multi_dataloader_tri
from configuration.mmformer import args
import torch
import torch.nn as nn
from lib.model_develop import train_base_multi_mmformer_tri
...
def deeppix_main(args):
    ...
    args.retrain = False
    train_base_multi_mmformer_tri(model=model, cost=criterion, optimizer=optimizer, train_loader=train_loader,
