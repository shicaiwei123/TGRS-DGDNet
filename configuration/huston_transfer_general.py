...
parser.add_argument('--lambda_kd_feature', type=float, default=25.0)
...
parser.add_argument('fusion_method', type=str, default='share')
parser.add_argument('gpu', type=int, default=0)
parser.add_argument('version', type=int, default=0)

args = parser.parse_args()
# args.lambda_kd_feature = 25

args.pair_modalities = args.pair_modalities.split('+')
os.environ['CUDA_VISIBLE_DEVICES'] = str(args.gpu)
args.name = args.pair_modalities[0] + "_" + args.pair_modalities[
    1] + "_" + args.backbone + "_version_" + str(args.version)+ "_lambda_kd_feature_"+str(args.lambda_kd_feature)+ "_lambda_center_loss_"+str(args.lambda_center_loss)
