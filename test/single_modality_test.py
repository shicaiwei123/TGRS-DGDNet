...
def deeppix_main(args):
    ...
    args.data_root = "/home/bigspace/shicaiwei/remote_sensing/honston2013_pixel7"
    args.modal = 'hsi'
    ...
    model.load_state_dict(
        torch.load(os.path.join(args.model_root, 'single_to_single_vkd_mse_fc_lidar_hsi_lr_0.001_version_1.pth')))
    model.eval()

    args.retrain = False
    result = calc_accuracy(model=model, loader=test_loader, hter=False, verbose=True)
    print(result)
